...
{
    [TestClass]
    public class GerenciadorReservasBITTests
    {
        //Teste de integração feito "na mão"
        [TestMethod]
        ...
        //NSubstitute mesclado com Teste de integração
        [TestMethod]
        public void AprovarReservaComCarroDisponivelDeveAtribuirStatusReservado()
        {
            ...
            IReservas reserva = Entidades.Reservas.Get(1); //Reserva 6 não existente
            reserva.Status = ReservasStatusListaItens.ItemAguardandoAprovacao;
            reserva.ModeloCarroHandle = 10;
