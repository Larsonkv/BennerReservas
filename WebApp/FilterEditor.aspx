...
<%@ Register Src="~/uc/FilterEditorControl.ascx" TagName="filterEditorControl" TagPrefix="wesUserControls" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
            ...
            <asp:UpdatePanel ID="filterEditorUpdatePanel" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txFilterName" class="form-control filter-name" CausesValidation="true" runat="server" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                    ...
                    <div class="row">
						...
						<div class="col-md-3">
                            <asp:CheckBox ID="cbShowSimpleSearch" Checked="true" Text="Apresentar pesquisa simples junto as condições" runat="server" />
                        </div>
                        <div class="col-md-3">
    ...
    <wesUserControls:filterEditorControl ID="filterEditorControl" runat="server" />
</asp:Content>
