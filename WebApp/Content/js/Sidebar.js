...
Sidebar.sincronize = function () {
    $('.page-sidebar .nav-item.active.open:first').parents('.sub-menu:first').toggle();
    $('.page-sidebar-menu.hidden-sm.hidden-xs .nav-item.active').last().addClass('current-active-menu-item');
    $('.page-sidebar-menu.visible-sm.visible-xs .nav-item.active').last().addClass('current-active-menu-item');
}
