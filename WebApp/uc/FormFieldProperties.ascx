...
<div class="portlet">
    ...
    <div class="portlet-body">
        ...
        <asp:Panel ID="divExtension" CssClass="form-group" runat="server">
            <asp:Label ID="Label26" CssClass="control-label" runat="server" Text="Extensão"></asp:Label>
            <asp:TextBox ID="txtExtension" placeholder=".png, .xml, .doc" CssClass="form-control" runat="server"></asp:TextBox>
        </asp:Panel>
        ...
        <asp:Panel ID="divPathField" CssClass="form-group" runat="server">
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <button class="btn btn-default" type="button" onclick="javascript:Benner.TextEditor.show('../TextEditor.aspx','<%= txtPath.ClientID %>');">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn" style="vertical-align: top">
                        <button class="btn btn-default"
                            onclick="javascript:Benner.Apps.CustomField.show('EditCustomField.aspx','<%= txtLabelValue.ClientID %>', '<%= cmbLabelValueType.ClientID %>');">
                            <i class="fa fa-pencil"></i>
                        </button>
                    </span>
                </div>
        ...
        <asp:Panel ID="divLookup" runat="server" Visible="false">
            ...
            <div class="form-group boolean-control-editor">
                <asp:CheckBox runat="server" ID="chkSelectAnyStructuredLevel" Text="Selecionar qualquer nível" />
            </div>
            <div class="form-group boolean-control-editor">
                    <asp:CheckBox runat="server" ID="chkSearchEnter" Text="Pesquisa ao pressionar enter" ToolTip="Use em tabelas com muitos registros para evitar a consulta no banco de dados enquanto o usuário está digitando." />
                </div>
        ...
        <asp:Panel ID="divFilterMode" CssClass="form-group" Visible="false" runat="server">
            <asp:Label ID="Label24" CssClass="control-label" runat="server" Text="Filtro empresa filial" ></asp:Label>
            <asp:DropDownList runat="server" CssClass="form-control" ID="cmbCompanyFilterMode"/>
        </asp:Panel>
