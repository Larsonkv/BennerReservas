...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="Benner.Tecnologia.Wes.Components.WebApp.FilterEditorControl" %>
        ...
        <asp:MultiView ID="multiViewFilter" ActiveViewIndex="0" runat="server">
            <asp:View runat="server" ID="viewConditions">
                <div class="portlet light ignore-autofocus">
                    ...
                    <div class="legend-filter"><span class="box bg-filter-parent"></span>
                        Tabela acima
                    ...
                    <div class="legend-filter"><span class="box bg-filter-child"></span>
                        Tabela abaixo                        
                        <div class="label-title-help">
