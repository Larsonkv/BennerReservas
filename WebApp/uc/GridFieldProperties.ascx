...
<asp:Panel ID="divNamedField" runat="server" Visible="false">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <span class="input-group-btn" style="vertical-align: top">
                <button class="btn btn-default"
                    onclick="javascript:Benner.Apps.CustomField.show('EditCustomField.aspx','<%= txtValueCustom.ClientID %>', '<%= cmbLabelValueType.ClientID %>');">
...
<asp:Panel ID="divSQLField" CssClass="form-group" runat="server" Visible="false">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <span class="input-group-btn">
                <button class="btn btn-default" onclick="javascript:Benner.TextEditor.show('../TextEditor.aspx','<%= txtExpression.ClientID %>');">
                    <i class="fa fa-pencil"></i>
                </button>
            </span>
        </div>
...
<asp:Panel ID="divVisibilidade" runat="server" CssClass="form-group">
    <asp:Label ID="Label12" runat="server" CssClass="control-label" Text="Visibilidade"></asp:Label>
    <asp:DropDownList ViewStateMode="Disabled" EnableViewState="false" ID="cmbVisibility" AutoPostBack="true" OnSelectedIndexChanged="OnFieldVisibilityChange" CssClass="form-control" runat="server">
    </asp:DropDownList>
</asp:Panel>

<asp:CheckBox runat="server" ID="chkSearchable" Text="Pesquisável<i class='fa fa-question-circle help-tooltip' data-original-title='É incluído na pesquisa simples'></i>" />