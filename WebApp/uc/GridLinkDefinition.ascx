...
<div class="form-group">
    <label class="control-label name column-nowrap">
        <div class="label-form">   
            ...
            <div class="label-title-help">
                <i class="fa fa-question-circle help-tooltip" data-original-title="Filtro selecionado previamente ao visualizar o Grid"></i>
            </div>
        </div>
    </label>
    <div class="input-group">
        <asp:DropDownList  ID="cmbDefaultFilter" CssClass="form-control" runat="server"></asp:DropDownList>
    </div>
</div>
...
<div class="form-group">
    <label class="control-label name column-nowrap">
        <div class="label-form">   
            ...
            <div class="label-title-help">
                <i class="fa fa-question-circle help-tooltip" data-original-title="É possível usar as funções @CAMPO e @CRITERIOSELECAO, que serão substituídas pelas informações do contexto do widget."></i>
            </div>
        </div>
    </label>
    <div class="input-group">
