...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    <link href="<%= Page.ResolveUrl("~/content/css/DataSourceEditor.css") %>" rel="stylesheet">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:CheckBox Text="Contém dados LGPD" runat="server" ClientIDMode="Static" ID="ContainsLgpd" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="portlet">
                                        <div class="portlet-body">
                                            <div class="form-control" style="height: 400px" id="selectCommand"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="portlet">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div id="numberGroup" hidden>                                            
                                            <div class="form-group">
                                                <label for="txtDecimals" class="control-label">Decimais:</label>
                                                <asp:TextBox runat="server" ClientIDMode="Static" class="form-control" ID="txtDecimals" TextMode="Number" Text="2"/>
                                            </div>
                                        </div>
                                        <div id="dateTimeGroup" hidden>
                                            <div class="form-group">
                                                <label for="" class="control-label">Formato de Data:</label>
                                                <asp:DropDownList runat="server" ClientIDMode="Static" type="text" class="form-control" ID="cmbDateFormat" />
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="control-label">Formato de hora:</label>
                                                <asp:DropDownList runat="server" ClientIDMode="Static" type="text" class="form-control" ID="cmbTimeFormat" />
                                            </div>
                                        </div>
    ...
    <script>
        $(function () {
            Benner.Apps.DataSourceEditor.init();
        })
    </script>
</asp:Content>
