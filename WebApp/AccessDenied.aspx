<%@ Page Title="Acesso Negado" Language="C#" Inherits="Benner.Tecnologia.Wes.Components.WebApp.AccessDeniedPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    <div class="row">
        <div class="col-md-12 page-401">
            ...
            <%if (CollectAuthorizationDetails) 
                { %>
                <div style="text-align:left; margin-top:50px;">
                    <h4>Detalhes para diagnóstico:</h4>
                    <%= PrintAuthorizationDetails() %>
                </div>
            <%} %>
        </div>
